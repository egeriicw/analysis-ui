 ...
 */
export default class AggregateAccessibilityComponent extends PureComponent<Props, State> {
  state = {
  ...
  setPercentileOfAccessibility = (e: SyntheticInputEvent<HTMLInputElement>) => {
    this.setState({percentileOfAccessibility: parseInt(e.target.value, 10)})
  }
