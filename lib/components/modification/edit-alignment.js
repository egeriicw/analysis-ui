...
export default class EditAlignment extends PureComponent<Props, State> {
  ...
  _onExtendFromEndChange = (e: SyntheticInputEvent<HTMLInputElement>) => {
    this._updateMapState({extendFromEnd: e.target.checked})
  }

  _onFollowRoadChange = (e: SyntheticInputEvent<HTMLInputElement>) => {
   ...
   */
  _onBidirectionalChange = (e: SyntheticInputEvent<HTMLInputElement>) => {
   ...
   */
  _onAutoCreateStopsChange = (e: SyntheticInputEvent<HTMLInputElement>) => {
   ...
   * Set stop spacing
   */
  _onStopSpacingChange = (e: SyntheticInputEvent<HTMLInputElement>) => {
